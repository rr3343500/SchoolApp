...
import com.schoolerp20.students.adapter.AdapterLiveClasses;
...
public class VideoHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = new User( VideoHistory.this );
       ...
       /* String frameVideo = "<html><body>Video From YouTube<br><iframe width=\"420\" height=\"315\" src=\"https://www.youtube.com/embed/47yJ2XCRLZs\" frameborder=\"0\" allowfullscreen></iframe></body></html>";
        ...
        compositeDisposable.add( apiServise.getvideo( "true", user.getUserid(), user.getPassword() )
                ...
                .subscribe( new Consumer<LiveClassessOne>() {
                    ...
                    public void accept(LiveClassessOne liveClassessOne) throws Exception {
                        ...
                        AdapterLiveClasses attendence = new AdapterLiveClasses( VideoHistory.this.getLifecycle(), liveClassessOne );
